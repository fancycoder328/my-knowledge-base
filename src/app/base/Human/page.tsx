...
export default function Human() {
    ...
    const content = (
        <>
            <p>
                <Bold>Humans</Bold> (<Bold>Homo Sapiens</Bold>) or <Bold>modern humans </Bold> are the most common and widespread <Link slug="Species" title="species" /> of <Link slug="Primate" title="primate" /> and the last surviving species of the genus <Link slug="Homo" title="Homo" />. They are <Link slug="Hominidae" title="great-apes" /> characterized by their <Link slug="Prehistory_of_nakedness_and_clothing" title="hairlessness" />, <Link slug="Bipedality" title="bipedalism" />, and high-<Link slug="Human_intelligence" title="intelligence" />. Humans have large <Link slug="Human_Brain" title="brains" />, enabling more advanced <Link slug="Cognition" title="cognitive" /> skills that enable them to thrive and adapt in varied environments, develop highly complex tools, and form complex social structures and <Link slug="Civilization" title="civilizations" />. Humans are highly-social, with individual humans tending to belong to a multi-layered network of cooperating, distinct, or even competing social-groups — from families and peer-groups to corporations and political states. As such, social interactions established a wide variety of values, social norms, <Link slug="Language" title="languages" />, and traditions (collective termed institution) each of which bolsters human society. Humans are also highly <Link slug="Curiosity" title="curious" />: the desire to understand and influence <Link slug="Phenomenon" title="phenomena" /> has motivated humanity&apos;s development of <Link slug="Science" title="science" />, <Link slug="Technology" title="technology" />, philosophy, <Link slug="Mythology" title="mythology" />, <Link slug="Religion" title="religion" />, and other frameworks of <Link slug="Knowledge" title="knowledge" />; humans also study themselves through such domains as <Link slug="Anthropology" title="anthropology" />, <Link slug="Social_science" title="social science" />, <Link slug="History" title="history" />, <Link slug="Psychology" title="psychology" />, and <Link slug="Medicine" title="medicine" />. As of April 2024, there are estimated to be more than <Redirect href="https://www.worldometers.info/world-population/" text="8 billion humans" /> alive.
                <br />
                <br />
                Although some scientists equate the term &quot;humans&quot; with all members of the genus <i>Homo</i>, in common usage it generally refers to Homo sapiens, the only extant member. All other members of the genus Homo, which are now extinct, are known as archaic humans, and the term &quot;modern human&quot; is used to distinguish Homo sapiens from archaic humans. Anatomically modern humans emerged around 300,000 years ago in Africa, evolving from <i>Homo heidelbergensis</i> or a similar species. Migrating out of Africa, they gradually replaced and interbred with local populations of archaic humans. Multiple hypotheses for the extinction of archaic human species such as <i>Neanderthals</i> include competition, violence, interbreeding with <i>Homo Sapiens</i>, or inability to adapt to climate change.
                <br />
                <br />
                For most of their history, humans were <Link slug="Nomadic" title="nomadic" /> hunter-gatherers. Humans began exhibiting <Link slug="Behavioral_modernity" title="behavioral modernity" /> about 160,000–60,000 years ago. The Neolithic Revolution, which began in Southwest Asia around 13,000 years ago (and separately in a few other places), saw the emergence of <Link slug="Agriculture" title="agriculture" /> and permanent human settlement; in turn, this led to the <Link slug="Cradle_of_humanity" title="development of civilization" /> and kickstarted a period of continuous (and ongoing) population growth and rapid <Link slug="Technological_change" title="technological change" />. Since then, a number of civilizations have risen and fallen, while a number of <Link slug="Socioculture" title="sociocultural" /> and <Link slug="History_of_technology" title="technological" /> developments have resulted in significant changes to the human lifestyle.
                <br />
                <br />
                <Link slug="Gene" title="Genes" /> and the environment influence human biological variation in visible characteristics, physiology, disease susceptibility, mental abilities, body size, and life span. Though humans vary in many traits (such as genetic predispositions and physical features), humans are among the least genetically diverse primates. Any two humans are at least 99% genetically similar. Humans are sexually dimorphic: generally, males have greater body strength and females have a higher body fat percentage. At puberty, humans develop secondary sex characteristics. Females are capable of <Bold>pregnancy</Bold>, usually between <Bold>puberty</Bold>, at around 12 years old, and menopause, around the age of 50.
                <br />
                <br />
                Humans are omnivorous, capable of consuming a wide variety of plant and animal material, and have used fire and other forms of heat to prepare and cook food since the time of <i>Homo erectus</i>. Humans can survive for up to eight weeks without food and several days without water. Humans are generally diurnal, sleeping on average seven to nine hours per day. Childbirth is dangerous, with a high risk of complications and death. Often, both the mother and the father provide care for their children, who are helpless at birth.
                <br />
                <br />
                Humans have a large, highly developed, and complex prefrontal cortex, the region of the brain associated with higher cognition. Humans are highly intelligent and capable of episodic memory; they have flexible facial expressions, self-awareness, and a theory of mind. The human mind is capable of introspection, private thought, imagination, volition, and forming views on existence. This has allowed great technological advancements and complex tool development through complex reasoning and the transmission of knowledge to subsequent generations through <Link slug="Language" title="language" />.
            </p>
            <ParagraphSecondaryHeader id="Etymology_and_definition">Etymology and definition</ParagraphSecondaryHeader>
            <p id="Etymology_and_definition">
                All modern humans are classified into the <Link slug="Species" title="species" /> <i>Homo sapiens</i>, coined by Carl Linnaeus in his 1735 work <i>Systema Naturae</i>. The <Redirect href="/base/Genus#Generic_name" text="generic name" /> &quot;<Link slug="Homo" title="Homo" />&quot; is a learned 18th-century derivation from Latin <i>homō</i>, which refers to humans of either sex. The word <i>human</i> can refer to all members of the <i>Homo</i> genus. The name &quot;<i>Homo sapiens</i>&quot; means &apos;wise man&apos; or &apos;knowledgeable man&apos;. There is disagreement if certain extinct members of the genus, namely Neanderthals, should be included as a separate species of humans or as a subspecies of <i>H. sapiens</i>.
                <br />
                <br />
                <i>Human</i> is a loanword of Middle English from Old French <i>humain</i>, ultimately from Latin <i>hūmānus</i>, the adjectival form of <i>homō</i> (&apos;man&apos; – in the sense of humanity). The native English term <i>man</i> can refer to the species generally (a synonym for idhumanity) as well as to human males. It may also refer to individuals of either sex.
                <br />
                <br />
            </p>
            <ReferencingVisual src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/41/Carl_von_Linn%C3%A9%2C_1707-1778%2C_botanist%2C_professor_%28Alexander_Roslin%29_-_Nationalmuseum_-_15723.tif/lossy-page1-170px-Carl_von_Linn%C3%A9%2C_1707-1778%2C_botanist%2C_professor_%28Alexander_Roslin%29_-_Nationalmuseum_-_15723.tif.jpg" w={400} h={450} caption={
                (
                    <>
                        Carl Linnaeus coined the name <i>Homo sapiens</i>
                    </>
                )
            } />
            <br />
            <br />
            <p>
                Despite the fact that the word <i>animal</i> is colloquially used as an antonym for <i>human</i>, and contrary to a common biological misconception, humans are animals. The word <i>person</i> is often used interchangeably with <i>human</i>, but philosophical debate exists as to whether personhood applies to all humans or all sentient beings, and further if one can lose personhood (such as by going into a persistent vegetative state).
            </p>
            <ParagraphSecondaryHeader id="Evolution">Evolution</ParagraphSecondaryHeader>
            <p id="Evolution">
                Humans are apes (superfamily Hominoidea). The lineage of apes that eventually gave rise to humans first split from gibbons (family Hylobatidae) and orangutans (genus <i>Pongo</i>), then gorillas (genus <i>Gorilla</i>), and finally, chimpanzees and bonobos (genus <i>Pan</i>). The last split, between the human and chimpanzee–bonobo lineages, took place around 8–4 million years ago, in the late Miocene epoch. During this split, chromosome 2 was formed from the joining of two other chromosomes, leaving humans with only 23 pairs of chromosomes, compared to 24 for the other apes. Following their split with chimpanzees and bonobos, the <Bold>hominins</Bold> diversified into many species and at least two distinct genera. All but one of these lineages – representing the genus <i>Homo</i> and its sole extant species <i>Homo sapiens</i> – are now extinct.
                <br />
                <br />
                The genus <i>Homo</i> evolved from <i>Australopithecus</i>. Though fossils from the transition are scarce, the earliest members of <i>Homo</i> share several key traits with <i>Australopithecus</i>. The earliest record of <i>Homo</i> is the 2.8 million-year-old specimen LD 350-1 from Ethiopia, and the earliest named species are <i>Homo habilis</i> and <i>Homo rudolfensis</i> which evolved by 2.3 million years ago. <i>H. erectus</i> (the African variant is sometimes called <i>H. ergaster</i>) evolved 2 million years ago and was the first archaic human species to leave Africa and disperse across Eurasia. <i>H. erectus</i> also was the first to evolve a characteristically human body plan. <i>Homo sapiens</i> emerged in Africa around 300,000 years ago from a species commonly designated as either <i>H. heidelbergensis</i> or <i>H. rhodesiensis</i>, the descendants of <i>H. erectus</i> that remained in Africa. <i>H. sapiens</i> migrated out of the continent, gradually replacing or interbreeding with local populations of archaic humans. Humans began exhibiting behavioral modernity about 160,000–70,000 years ago, and possibly earlier.
                <br />
                <br />
            </p>
            <ReferencingVisual src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/da/Lucy_Skeleton.jpg/170px-Lucy_Skeleton.jpg" w={400} h={450} caption={
                (
                    <>
                        Reconstruction of Lucy, the first <i>Australopithecus afarensis</i> skeleton found
                    </>
                )
            } />
            <br />
            <br />
            <p>
                The &quot;out of Africa&qout; migration took place in at least two waves, the first around 130,000 to 100,000 years ago, the second (Southern Dispersal) around 70,000 to 50,000 years ago. <i>H. sapiens</i> proceeded to colonize all the continents and larger islands, arriving in Eurasia 125,000 years ago, Australia around 65,000 years ago, the Americas around 15,000 years ago, and remote islands such as Hawaii, Easter Island, Madagascar, and New Zealand in the years 300 to 1280 CE.
                <br />
                <br />
                Human evolution was not a simple linear or branched progression but involved interbreeding between related species. Genomic research has shown that hybridization between substantially diverged lineages was common in human evolution. <Link slug="DNA" title="DNA" /> evidence suggests that several genes of Neanderthal origin are present among all non sub-Saharan-African populations, and Neanderthals and other hominins, such as Denisovans, may have contributed up to 6% of their <Link slug="Genome" title="genome" /> to present-day non sub-Saharan-African humans.
                <br />
                <br />
                Human evolution is characterized by a number of morphological, developmental, physiological, and behavioral changes that have taken place since the split between the last common ancestor of humans and chimpanzees. The most significant of these adaptations are <Redirect href="/base/Prehistory_of_nakedness_and_hairlessness#Evolution_of_hairlessness" text="hairlessness" />, obligate <Link slug="Bipedality" title="bipedalism" />, increased <Link slug="Human_Brain" title="brain" /> size and decreased sexual dimorphism (neoteny). The relationship between all these changes is the subject of ongoing debate.
                <br />
                <br />
            </p>
            <ReferencingVisual src="/in-page-assets/homo-sapiens-evolution-tree.png" w={500} h={1000} caption={<></>} />
            <br />
            <br />
            <ParagraphSecondaryHeader id="History">History</ParagraphSecondaryHeader>
            <h1 className="text-xl font-bold">Prehistory</h1>
            <br />
            <p id="History">
            ...
            <ReferencingVisual src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/8b/Early_migrations_mercator.svg/350px-Early_migrations_mercator.svg.png" w={450} h={500} caption={
                (
                    <>
            ...
            <h1 className="text-xl font-bold">Medieval</h1>
            <br />
            <p>
            ...
            <ReferencingVisual src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/cd/Cleric-Knight-Workman.jpg/170px-Cleric-Knight-Workman.jpg" w={200} h={200} caption={
                (
                    <>
                        Medieval French manuscript illustration of the three classes of medieval society from the 13th-century <i>Li Livres dou Santé</i>
                    </>
                )
            } />
            <br />
            ...
            <h1 className="text-xl font-bold">Modern</h1>
            <br />
            <p>
            ...
            <ReferencingVisual src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/Maquina_vapor_Watt_ETSIIM.jpg/220px-Maquina_vapor_Watt_ETSIIM.jpg" w={400} h={400} caption={
                (
                    <>
            ...
            <h1 className="text-xl font-bold">Contemporary</h1>
            <br />
            <p>
                Following the conclusion of the Second World War in 1945, the Cold War between the USSR and the United States saw a struggle for global influence, including a nuclear arms race and a space race, ending in the collapse of the Soviet Union. The current Information Age, spurred by the development of the Internet and <Link slug="AI" title="Artificial Intelligence" /> systems, sees the world becoming increasingly globalized and interconnected.
            </p>
            <ParagraphSecondaryHeader id="Habitat_and_population">Habitat and population</ParagraphSecondaryHeader>
            <p id="Habitat_and_population">
            ...
            <h3 className="text-lg text-center">Population statistics</h3>
            <ReferencingVisual src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2e/Population_Density%2C_v4.11%2C_2020_%2848009093621%29.jpg/450px-Population_Density%2C_v4.11%2C_2020_%2848009093621%29.jpg" w={600} h={550} caption={
                (
                    <>
                        Choropleth showing Population density (people per square kilometer) estimates by 30 arc-second grid in 2020
                        <Divider />
                        <div className="text-left">
                            <Bold>World Population</Bold>: 8.1 billion
                            <br />
                            <Bold>Population density</Bold>: 16/km2 (41/sq mi) by total area; 54/km2 (140/sq mi) by land area
                            <br />
                            <Bold>Largest cities</Bold>: Tokyo, Delhi, Shanghai, São Paulo, Mexico City, Cairo, Mumbai, Beijing, Dhaka, Osaka, New York-Newark, Karachi, Buenos Aires, Chongqing, Istanbul, Kolkata, Manila, Lagos, Rio de Janeiro, Tianjin, Kinshasa, Guangzhou, Los Angeles-Long Beach-Santa Ana, Moscow, Shenzhen, Lahore, Bangalore, Paris, Jakarta, Chennai, Lima, Bogota, Bangkok, London
                        </div>
                    </>
                )
            } />
            ...
            <ReferencingVisual src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/17/Distribution-of-earths-mammals.png/330px-Distribution-of-earths-mammals.png" w={400} h={400} caption={
                (
                    <>
    ...
    return (
        <Layout topic="Hominidae" title="Human" thumbnail="/assets/homo-sapiens.png" content={content} />
    );
};