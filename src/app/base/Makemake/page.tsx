    ...
    const content = (
        <>
            ...
            <p>
                ...
                <br />
                <br />
                Planetary symbols are no longer much used in astronomy. A Makemake symbol is included in Unicode as U+1F77C: it is mostly used by astrologers, but has also been used by <Link slug="NASA" title="NASA" />. The symbol was designed by Denis Moskowitz and John T. Whelan; it is a traditional petroglyph of Makemake&apos;s face stylized to resemble an &apos;M&apos;. The commercial Solar Fire astrology software uses an alternative symbol, a crossed variant of a symbol created by astrologer Henry Seltzer for his commercial software.
            </p>
            <ParagraphSecondaryHeader id="Orbital_and_classification">Orbital and classification</ParagraphSecondaryHeader>
            <span id="Orbital_and_classification"></span>
            <ReferencingVisual src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/fe/TheKuiperBelt_Orbits_2003EL61_2005FY9.svg/220px-TheKuiperBelt_Orbits_2003EL61_2005FY9.svg.png" w={200} h={100} caption={
                (
                    <>
            ...
            <ParagraphSecondaryHeader id="Physical_characteristics">Physical characteristics</ParagraphSecondaryHeader>
            <span id="Physical_characteristics"></span>
            <ReferencingVisual src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/ec/Makemake-LB1-2009Nov26-11UT.jpg/220px-Makemake-LB1-2009Nov26-11UT.jpg" w={250} h={400} caption={
                (
                    <>
                        Makemake (located by the arrow) (apparent magnitude 16.9) with edge-on galaxy IC 3587
                    </>
                )
            } />
            <br />
            ...
            <ReferencingVisual src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/98/Quaoar_Haumea_Makemake_orbits_2018.png/310px-Quaoar_Haumea_Makemake_orbits_2018.png" w={250} h={500} caption={
                (
                    <>
            ...
            <br />
            <p>
                The rotation period of Makemake is estimated at 22.83 hours.[14] A rotation period of 7.77 hours published in 2009[49] later turned out to be an alias of the actual rotation period. The possibility of this had been mentioned in the 2009 study, and the data from that study agrees well with the 22.83-hour period.[14] This rotation period is relatively long for a dwarf planet. Part of this may be due to tidal acceleration from Makemake&apos;s satellite. It has been suggested that a second large, undiscovered satellite might better explain the dwarf planet&apos;s unusually long rotation.
                <br />
                <br />
                Makemake&apos;s lightcurve amplitude is small, only 0.03 <i>mag</i>. This was thought to be due to Makemake currently being viewed pole on from Earth; however, <Link slug="S_2015_(136472)_1" title="S/2015 (136472)" />&apos;s orbital plane (which is probably orbiting with little inclination relative to Makemake&apos;s equator due to tidal effects) is edge-on from Earth, implying that Makemake is being viewed equator-on.
                <br />
                <br />
            </p>
            <SubTitle>Spectra and surface</SubTitle>
            <p>
                Like Pluto, Makemake appears red in the visible spectrum, and significantly redder than the surface of Eris. The near-infrared spectrum is marked by the presence of the broad methane (CH4) absorption bands. Methane is observed also on Pluto and Eris, but its spectral signature is much weaker.
                <br />
                <br />
            ...
            <ReferencingVisual src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/93/Makemake_moon_artist%27s_view_with_legend.jpg/220px-Makemake_moon_artist%27s_view_with_legend.jpg" w={250} h={270} caption={
                (
                    <>
